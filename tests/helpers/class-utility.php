...
class Utility {
	 ...
	 */
	public static function invoke_method( $object_or_class_name, $method_name, array $parameters = [] ) {
	 ...
	 * @throws \ReflectionException
	 */
	public static function set_and_get_property( $object_or_class_name, $property_name, $property_value ) {
