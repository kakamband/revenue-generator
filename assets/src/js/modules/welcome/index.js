			...
			<div className="welcome-screen-wrapper">
				<div className="welcome-screen">
					...
					<p className="welcome-screen__description">
						{
							__(
								'Your readers and viewers already love your content - LaterPay\'s revenue generator makes ' +
								'it easy for them to support you. Sell individual pieces of content, timed access to your site, ' +
								'or recurring subscriptions - at any price point.', 'revenue-generator')
						}
						{
							__( 'Instead of requiring upfront registration and payment, we defer this process until customer ' +
								'purchases combined reach a $5 threshold. Earn money from all of your users, not just subscribers.',
								'reveue-generator' )
						}
					</p>
				</div>
