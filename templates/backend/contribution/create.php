	...
	<div class="rev-gen-layout-wrapper">
		...
		<form method="post" class="rev-gen-contribution-form">
			...
			<div class="rev-gen-contribution-main-inputs-wrapper">
				...
				<p class="rev-gen-contribution-main__p"><?php _e( 'You\'re editing an older version of the Contribution shortcode. For the changes to take effect, you’ll need to replace existing codes in your content with the new one that will be generated by clicking below.', 'revenue-generator' ); ?><br><?php _e( 'In the future, your Contribution offering will be automatically updated throughout your site when you edit it here.', 'revenue-generator' ); ?></p>
				<?php endif; ?>
