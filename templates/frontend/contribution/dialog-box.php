...
<?php } else { ?>
	<div class="rev-gen-contribution rev-gen-contribution--box is-style-wide<?php echo esc_attr( $amp_class ); ?>" id="<?php echo esc_attr( $html_id ); ?>">
			<div class="rev-gen-contribution__inner">
				...
				<div class="rev-gen-contribution__donate" id="donation-wrapper">
					<?php
					foreach ( $payment_config['amounts'] as $amount_info ) {
						...
						?>
						<div data-revenue="<?php echo esc_attr( $amount_info['revenue'] ); ?>" data-campid="<?php echo esc_attr( $campaign_id ); ?>" class="rev-gen-contribution__donation">
							<?php if ( $is_preview ) : ?>
